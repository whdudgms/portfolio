...
<!-- REVOLUTION SLIDER -->
<link
	href="<c:url value='/resources/plugins/slider.revolution/css/extralayers.css'/>"
	rel="stylesheet" type="text/css" />
<link
	href="<c:url value='/resources/plugins/slider.revolution/css/settings.css'/>"
	rel="stylesheet" type="text/css" />
...
<!-- THEME CSS -->
<link href="<c:url value='/resources/css/essentials.css'/>"
	rel="stylesheet" type="text/css" />
<link href="<c:url value='/resources/css/layout.css'/>" rel="stylesheet"
	type="text/css" />

<!-- PAGE LEVEL SCRIPTS -->
<link href="<c:url value='/resources/css/header-1.css'/>"
	rel="stylesheet" type="text/css" />
<link href="<c:url value='/resources/css/color_scheme/green.css'/>"
	rel="stylesheet" type="text/css" id="color_scheme" />

<!-- JAVASCRIPT FILES -->
<script>var plugin_path = "<c:url value='/resources/plugins/'/>";</script>
<script
	src="<c:url value='/resources/plugins/jquery/jquery-3.3.1.min.js'/>"></script>
...
<!-- REVOLUTION SLIDER -->
<script
	src="<c:url value='/resources/plugins/slider.revolution/js/jquery.themepunch.tools.min.js'/>"></script>
<script
	src="<c:url value='/resources/plugins/slider.revolution/js/jquery.themepunch.revolution.min.js'/>"></script>
<script
...
<body class="smoothscroll enable-animation">
	...
	<div id="wrapper">
			...
			<div class="container">
				...
				<ul class="top-links list-inline float-right">
					<c:choose>
						...
						<c:otherwise>
							<li><a tabindex="-1"
								href="javascript:movePage('/member/goLoginPage.do')">LOGIN</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
			</div>
		...
		<div id="header"
			class="navbar-toggleable-md sticky shadow-after-3 clearfix">
			<!-- TOP NAV -->
			<header id="topNav">
			<div class="container">
				<!-- Mobile Menu Button -->
				...
				<!-- Logo -->
				<a class="logo float-left" href="<c:url value='/index.do'/>"> <img
					src="<c:url value=''/>" alt="" />
				</a>
				...
				<div
					...
					<ul id="topMain" class="nav nav-pills nav-main">
						...
						<li class="dropdown">
							<!-- PROFILE --> <a class="dropdown-toggle noicon"
							href="javascript:movePage('/profile.do')"> PROFILE </a>
						</li>
						<li class="dropdown">
							<!-- SPRING BOARD --> <a class="dropdown-toggle"> SPRING
								BOARD </a>
						...
						<li class="dropdown">
							<!-- NOTES --> <a class="dropdown-toggle noicon"
							href="javascript:movePage('/devNotes.do')"> DEV-NOTES </a>
						</li>


						<c:if
							test='${sessionScope.memberId != null && sessionScope.memberType ==9 }'>
							<li class="dropdown mega-menu">
								<!-- SHORTCODES --> <a class="dropdown-toggle noicon"
								href="javascript:movePage('/admin.do')"> ADMIN </a>
							</li>
						</c:if>
		...
		<div id="contentDiv">
			...
			<section style="padding:0"> <!-- REVOLUTION SLIDER-->
			<div class="slider fullwidthbanner-container roundedcorners">
				<div class="fullwidthbanner" data-height="600" data-shadow="0"
					...
					<ul class="hide">
						...
						<li data-transition="random" data-slotamount="1"
							...
							<div class="tp-caption customin ltl tp-resizeme large_bold_white"
								data-x="center" data-y="205"
								data-customin="x:0;y:150;z:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
								data-speed="800" data-start="1200" data-easing="easeOutQuad"
								data-splitin="none" data-splitout="none"
								data-elementdelay="0.01" data-endelementdelay="0.1"
								data-endspeed="1000" data-endeasing="Power4.easeIn"
								style="z-index: 10;">WELCOME TO MY WORLD</div>

							<div
								class="tp-caption customin ltl tp-resizeme small_light_white font-lato"
								...
								data-elementdelay="0.01" data-endelementdelay="0.1"
								data-endspeed="1000" data-endeasing="Power4.easeIn"
								style="z-index: 20; width: 100%; max-width: 750px; white-space: normal; text-align: center; font-size: 20px; line-height: 55px">
								이 사이트는 아래 기술을 이용하여 구현하였습니다. <br /> <span
									style="font-size: 20px; font-weight: 400; line-height: 30px">
									<ul>
										<li>Spring Framework 5.3.32 / myBatis 3.4.1 / jUnit 4.12</li>
										<li>jQuery 3.2.1/ jQuery UI 1.12.1/ jqGrid 4.4.3 / Maven
											/ log 4.12</li>
										<br />
						...
						<li data-transition="random" data-slotamount="1"
							...
							<div class="tp-caption very_large_text lfb ltt tp-resizeme"
								...
								data-voffset="-50" data-speed="600" data-start="800"
					...
					<div class="sidepanel-content">
						...
						<ul class="list-group">
							...
							<li class="list-group-item"><a
								href="<c:url value='/index.do'/>"> <i
									class="ico-category et-heart"></i> HOME
							</a></li>
							<li class="list-group-item"><a
								href="javascript:movePage('/profile.do')"> <i
									class="ico-category et-happy"></i> PROFILE
							</a></li>
							<li class="list-group-item"><a
								href="javascript:movePage('/notice/list.do')"> <i
									class="ico-category et-happy"></i> NOTICE
							</a></li>
							<li class="list-group-item"><a
								href="javascript:movePage('/board/list.do')"> <i
									class="ico-category et-happy"></i> FREE-BOARD
							</a></li>
