		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
					...
					tempore dolore dolorem quisquam porro modi voluptatum eum saepe
					dolorum.</p>
				<blockquote>
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				...
				<div class="progress progress-lg">
					<!-- progress bar -->
					<div
						class="progress-bar progress-bar-danger progress-bar-striped active text-left"
						role="progressbar" aria-valuenow="98" aria-valuemin="0"
						aria-valuemax="100" style="width: 98%; min-width: 2em;">
				...
				<div class="progress progress-lg">
					<!-- progress bar -->
					<div
						class="progress-bar progress-bar-success progress-bar-striped active text-left"
				...
				<div class="progress progress-lg">
					<!-- progress bar -->
					<div
						class="progress-bar progress-bar-info progress-bar-striped active text-left"
						role="progressbar" aria-valuenow="88" aria-valuemin="0"
						aria-valuemax="100" style="width: 88%; min-width: 2em;">
						<span>MYSQL 88%</span>
					</div>
				</div>
				<!-- /progress bar -->
